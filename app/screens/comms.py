...
class ScreenComms(LcarsScreen):
    def setup(self, all_sprites):
        ...
        all_sprites.add(LcarsText(colours.ORANGE, (0, 110), "Comms", 1.5),
                        layer=1)
        ...
        # info text
        all_sprites.add(LcarsText(colours.WHITE, (150, 110), "COMMS INFO:", 1.5),
                        layer=3)
        all_sprites.add(LcarsText(colours.BLUE, (210, 110), "FILES RECEIVED: 12 / 346.6 MB"),
                        layer=3)
        all_sprites.add(LcarsText(colours.BLUE, (235, 110), "FILES SENT: 2 / 196.2 MB"),
                        layer=3)
        all_sprites.add(LcarsText(colours.BLUE, (260, 110), "PENDING TRANSFERS: 0 / 0 MB"),
                        layer=3)
        ...
        # buttons
        all_sprites.add(LcarsButton(colours.PURPLE, (102, 105), "SEND FILE", self.infoHandler),
                        layer=4)
        all_sprites.add(LcarsButton(colours.BEIGE, (102, 212), "RECEIVE FILE", self.sensorsHandler),
                        layer=4)        
